...
-- Remove spaces at end and beginning of a string
         ...
         for line in stdout:gmatch("[^\r\n]+") do
            if starts_with(line, "cpu") then
               ...
               if is_update == true then
                  ...
                  local kill_process_button = enable_kill_button and create_kill_process_button() or nil
                  ...
                  if enable_kill_button then
                     row:connect_signal("mouse::enter", function()
                        kill_process_button.icon.opacity = 1
                     end)
                     row:connect_signal("mouse::leave", function()
                        kill_process_button.icon.opacity = 0.1
                     end)

                     kill_process_button:buttons(awful.util.table.join(awful.button({}, 1, function()
                        row:set_bg("#ff0000")
